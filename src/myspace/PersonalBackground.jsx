        ...
        <div className="col-lg-12">
          <form className="myspace-form mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="gender" id="gender">
                  ...
                  {GENDER.map((gender) =>
                    optionsWithDefaultSelection(gender, personalBackground.gender)
                  )}
                </select>
              </p>
            </div>
              ...
              <p className="input-control">
                ...
                <select className="custom-select" name="ethnicity" id="ethnicity">
                  ...
                  {ETHNICITY.map((ethnicity) =>
                    optionsWithDefaultSelection(ethnicity, personalBackground.ethnicity)
                  )}
                  ;
                </select>
              </p>
                ...
                <select className="custom-select" name="sexual_orientation" id="sexualOrientation">
                  ...
                  {SEXUAL_ORIENTATION.map((sexualOrientation) =>
                    optionsWithDefaultSelection(
                      sexualOrientation,
                      personalBackground.sexual_orientation
                    )
                  )}
                </select>
              </p>
            ...
            <form-group controlId="formSexualOrientationOther">
              <p className="input-control">
                <label htmlFor="sexualOrientationOther">
                  Other information on Sexual Orientation :
                </label>
                <input
                  className="field"
                  type="text"
              ...
              <p className="input-control">
                ...
                <select className="custom-select" name="religion" id="religion">
                  ...
                  {RELIGION.map((religion) =>
                    optionsWithDefaultSelection(religion, personalBackground.religion)
                  )}
                </select>
              </p>
            </div>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="physical_ability" id="physicalAbility">
                  ...
                  {PHYSICAL_ABILITY.map((physicalAbility) =>
                    optionsWithDefaultSelection(
                      physicalAbility,
                      personalBackground.physical_ability
                    )
                  )}
                </select>
              </p>
            ...
            <form-group controlId="formPhysicalAbilityOther">
              <p className="input-control">
                <label htmlFor="physicalAbilityOther">
                  Other information on Physical Ability :
                </label>
                <input
                  className="field"
                  type="text"
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="mental_ability" id="mentalAbility">
                  ...
                  {MENTAL_ABILITY.map((mentalAbility) =>
                    optionsWithDefaultSelection(mentalAbility, personalBackground.mental_ability)
                  )}
                </select>
              </p>
            </div>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="socio_economic" id="socioEconomic">
                  ...
                  {SOCIO_ECONOMIC.map((socioEconomic) =>
                    optionsWithDefaultSelection(socioEconomic, personalBackground.socio_economic)
                  )}
                </select>
              </p>
            </div>
              ...
              <p className="input-control">
                ...
                <select className="custom-select" name="highest_education" id="highestEducation">
                  ...
                  {HIGHEST_EDUCATION.map((highestEducation) =>
                    optionsWithDefaultSelection(
                      highestEducation,
                      personalBackground.highest_education
                    )
                  )}
                </select>
              </p>
            ...
            <form-group controlId="formHighestEducationOther">
              <p className="input-control">
                <label htmlFor="highestEducationOther">
                  Other information on Highest Education :
                </label>
                <input
                  className="field"
                  type="text"
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="years_of_experience" id="yearsOfExperience">
                  ...
                  {YEARS_OF_EXPERIENCE.map((yearsOfExperience) =>
                    optionsWithDefaultSelection(
                      yearsOfExperience,
                      personalBackground.years_of_experience
                    )
                  )}
                </select>
              </p>
            ...
            <div>
              <p>
                WARNING! By ticking the box below you are declaring that you have agreed for
                BridgeInTech to share your personal background information with its members
              </p>
            </div>
            <div>
              <br></br>
            ...
            <form-group controlId="formIsPublic">
              <div className="row">
                ...
                <div className="col-sm-10">
                  <label>
                    I allow other members of BridgeInTech to view my personal background
                    information.
                  </label>
                </div>
              </div>
