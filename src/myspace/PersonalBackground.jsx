...
export default function PersonalBackground() {
    ...
    useEffect(() => {
        ...
        fetch(`${BASE_API}/user/personal_background`, requestPersonalBackground)
            .then(async (response) => {
                ...
                if (response.ok) return setPersonalBackground(data);
    ...
    const handleSubmit = async (e) => {
        ...
        new FormData(e.target).forEach((value, key) => {
            ...
            if (key === "is_public") value = value === "true";
        ...
        fetch(`${BASE_API}/user/personal_background`, requestUpdateBackground)
            .then(async (response) => {
                ...
                if (response.ok) return setResponseMessage(data.message);
                setResponseMessage(data.message);
            })
            .catch(() => setResponseMessage(SERVICE_UNAVAILABLE_ERROR));
    };
                    ...
                    <form className="myspace-form mx-auto" onSubmit={handleSubmit}>
                        <form-group controlId="formUsername">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="username" placeholder={user} disabled />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="gender" id="gender">
                                    <option>{personalBackground.gender}</option>
                        ...
                        <form-group controlId="formGenderOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="gender_other" defaultValue={personalBackground.gender_other} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="age" id="age">
                                    <option>{personalBackground.age}</option>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="ethnicity" id="ethnicity">
                                    <option>{personalBackground.ethnicity}</option>
                        ...
                        <form-group controlId="formEthnicityOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="ethnicity_other" defaultValue={personalBackground.ethnicity_other} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="sexual_orientation" id="sexualOrientation">
                                    <option>{personalBackground.sexual_orientation}</option>
                        ...
                        <form-group controlId="formSexualOrientationOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="sexual_orientation_other" defaultValue={personalBackground.sexual_orientation_other} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="religion" id="religion">
                                    <option>{personalBackground.religion}</option>
                        ...
                        <form-group controlId="formReligionOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="religion_other" defaultValue={personalBackground.religion_other} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="physical_ability" id="physicalAbility">
                                    <option>{personalBackground.physical_ability}</option>
                        ...
                        <form-group controlId="formPhysicalAbilityOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="physical_ability_other" defaultValue={personalBackground.physical_ability_other} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="mental_ability" id="mentalAbility">
                                    <option>{personalBackground.mental_ability}</option>
                        ...
                        <form-group controlId="formMentalAbilityOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="mental_ability_other" defaultValue={personalBackground.mental_ability_other} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="socio_economic" id="socioEconomic">
                                    <option>{personalBackground.socio_economic}</option>
                        ...
                        <form-group controlId="formSocioEconomicOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="socio_economic_other" defaultValue={personalBackground.socio_economic_other} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="highest_education" id="highestEducation">
                                    <option>{personalBackground.highest_education}</option>
                        ...
                        <form-group controlId="formHighestEducationOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="highest_education_other" defaultValue={personalBackground.highest_education_other} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="years_of_experience" id="yearsOfExperience">
                                    <option>{personalBackground.years_of_experience}</option>
                        ...
                        <form-group controlId="formIsPublic">
                            <div className="row">
                                <div className="col-sm">
                                    <p className="input-control">
                                        <input type="checkbox" name="is_public" aria-label="isPublic" value={"on" ? true : false} defaultChecked={personalBackground.is_public} />
                                    </p>
                                </div>
                                <div className="col-sm-10">
                                    <label>I allow other members of BridgeInTech to view my personal background information.</label>
                                </div>
                            </div>
                        </form-group>
                        <div>
