...
export default function Register() {
    ...
    return (
        <div className="container">
            <div className="container boundryRegister">
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <form className="register-form mx-auto" onSubmit={handleSubmit}>
                            ...
                            <form-group>
                                <div className="row">
                                    <div className="col-lg text-center">
                                        <label className="float-left" htmlFor="availability">Available to be a :</label>
                                        <form-group>
                                                <div className="mb-3">
                                                    <div className="row">
                            ...
                            <div className="pt-2 pb-2 pl-3 row">
