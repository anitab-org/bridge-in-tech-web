      ...
      <div className="footer-container">
        <div className="main-flexbox">
          <div className="flexbox-item">
            ...
            <h4 className="text">
              We are known for connecting top talents with top companies. We make great
          ...
          <div className="flexbox-item">
            ...
            <ul className="list">
              <li className="li">
                <a
                  href="https://anitab.org/terms-of-use/"
                  className="Links"
                  target="_blank"
        ...
        <div className="bootomDiv">
          ...
          <div className="bottom-flexbox">
            <div className="bottom-flexboxitem">
              <h5 className="text-bottom">Bridge In Tech. All Rights Reserved.</h5>
            </div>
            <div className="bottom-flexboxitem">
              <a href="https://github.com/anitab-org" target="_blank" rel="noopener noreferrer">
                <img src={github} className="social-logos" alt="gihub_logo" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <img src={linkdin} className="social-logos" alt="linkdin_logo" />
              </a>
              <a
                href="https://twitter.com/anitab_org?lang=en"
                target="_blank"
                rel="noopener noreferrer"
              >
