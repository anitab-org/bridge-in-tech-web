    ...
    <div className="GITcontainer">
      <div className="formContainer">
        <form>
          <label>Name</label>
          <br></br>
          <input type="text" name="fname" placeholder="John Doe"></input>
          <br></br>
          ...
          <label>Message</label>
          <br></br>
          <input className="message" type="text" name="message" placeholder="Your message"></input>
          <br></br>
      ...
      <div className="textContainer">
        <div className="heading">
          <p>
            Get <span style={{ color: '#F1A140' }}>In Touch</span>
          </p>
        </div>
