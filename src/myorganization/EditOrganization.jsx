...
export default function EditOrganization() {
    ...
    const handleSubmit = async (e) => {
        ...
        new FormData(e.target).forEach((value, key) => {
            if (key === "representativeName") return;
            payload[key] = value;
        });
                    ...
                    <form className="organization-form mx-auto" onSubmit={handleSubmit}>
                        ...
                        <form-group controlId="formName">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" aria-labelledby="name" name="name" maxLength="150" defaultValue={organization.organization_name} required />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formEmail">
                            <p className="input-control">
                                ...
                                <input className="field" type="email" aria-labelledby="email" name="email" maxLength="254" defaultValue={organization.email} required />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formAbout">
                            <p className="input-control">
                                ...
                                <textarea className="field" type="text" aria-labelledby="about" name="about" maxLength="500" defaultValue={organization.about} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formAddress">
                            <p className="input-control">
                                ...
                                <textarea className="field" type="text" aria-labelledby="address" name="address" defaultValue={organization.address} maxLength="254" required />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formWebsite">
                            <p className="input-control">
                                ...
                                <input className="field" type="url" aria-labelledby="website" name="website" maxLength="150" defaultValue={organization.website} required />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="timezone" id="timezone">
                                    <option defaultValue="GMT0">{organization.timezone}</option>
                        ...
                        <form-group controlId="formPhone">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="phone" defaultValue={organization.phone} maxLength="20" pattern="^[0-9\s\-\+]+$" onChange={validatePhone} />
                            </p>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="status" id="status">
                                    <option defaultValue="Draft">{organization.status}</option>
                        ...
                        <form-group controlId="formJoinDate">
                            <p className="input-control">
                                ...
                                <input className="field" type="url" aria-labelledby="joinDate" name="joinDate" defaultValue={organization.join_date} disabled />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
