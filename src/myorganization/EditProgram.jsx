...
export default function EditProgram() {
  ...
  const handleSubmit = async (e) => {
    ...
    new FormData(e.target).forEach((value, key) => {
      if (key === 'organization_name' || key === 'representative_name' || key === 'creation_date')
        return;
      if (
        key === 'target_skills' ||
      ...
      console.log(value);
      if (key === 'start_date' || key === 'end_date' || key === 'creation_date')
    ...
    fetch(
      `${BASE_API}/organizations/${organization.id}/programs/${parameter_url}`,
  ...
  const creationDateArray = program
    ? program.creation_date.split(' ').map((item) => item.trim())
    : [];
        ...
        <div className="col-lg-12">
          <form className="program-form mx-auto" onSubmit={handleSubmit}>
            ...
            <form-group controlId="formStartDate">
              <p className="input-control">
                <label id="startDate">
                  Start Date : (in {program ? startDateArray[2] : 'GMT+00:00'} timezone)
                </label>
                <input
                  className="field"
                  ...
                  name="start_date"
                  defaultValue={
                    program ? `${startDateArray[0]}T${startDateArray[1]}` : 'YYYY-MM-DDT00:00'
                  }
                  required
                />
              </p>
            ...
            <form-group controlId="formEndDate">
              <p className="input-control">
                <label id="endDate">
                  End Date : (in {program ? endDateArray[2] : 'GMT+00:00'} timezone)
                </label>
                <input
                  className="field"
                  ...
                  name="end_date"
                  defaultValue={
                    program ? `${endDateArray[0]}T${endDateArray[1]}` : 'YYYY-MM-DDT00:00'
                  }
                  required
                />
              </p>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="target_candidate_gender">
                  ...
                  {GENDER.map((target_candidate_gender) =>
                    optionsWithDefaultSelection(
                      target_candidate_gender,
                      program ? program.target_candidate_gender : 'Not Applicable'
                    )
                  )}
                </select>
              </p>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="target_candidate_age">
                  ...
                  {AGE.map((target_candidate_age) =>
                    optionsWithDefaultSelection(
                      target_candidate_age,
                      program ? program.target_candidate_age : 'Not Applicable'
                    )
                  )}
                </select>
              </p>
                ...
                <select className="custom-select" name="target_candidate_ethnicity">
                  ...
                  {ETHNICITY.map((target_candidate_ethnicity) =>
                    optionsWithDefaultSelection(
                      ...
                      program ? program.target_candidate_ethnicity : 'Not Applicable'
                    )
                  )}
                </select>
              </p>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="target_candidate_sexual_orientation">
                  <option>
                    {program ? program.target_candidate_sexual_orientation : 'Not Applicable'}
                  </option>
                ...
                <select className="custom-select" name="target_candidate_religion">
                  ...
                  {RELIGION.map((target_candidate_religion) =>
                    optionsWithDefaultSelection(
                      ...
                      program ? program.target_candidate_religion : 'Not Applicable'
                    )
                  )}
                </select>
              </p>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="target_candidate_physical_ability">
                  <option>
                    {program ? program.target_candidate_physical_ability : 'Not Applicable'}
                  </option>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="target_candidate_mental_ability">
                  <option>
                    {program ? program.target_candidate_mental_ability : 'Not Applicable'}
                  </option>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="target_candidate_socio_economic">
                  <option>
                    {program ? program.target_candidate_socio_economic : 'Not Applicable'}
                  </option>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="target_candidate_highest_education">
                  <option>
                    {program ? program.target_candidate_highest_education : 'Not Applicable'}
                  </option>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="target_candidate_years_of_experience">
                  <option>
                    {program ? program.target_candidate_years_of_experience : 'Not Applicable'}
                  </option>
              ...
              <p className="input-control">
                ...
                <select className="custom-select" name="contact_type">
                  ...
                  {CONTACT_TYPE.map((contact_type) =>
                    optionsWithDefaultSelection(
                      contact_type,
                      program ? program.contact_type : 'Remote'
                    )
                  )}
                </select>
              </p>
            ...
            <div className="input-group mb-3">
              <p className="input-control">
                ...
                <select className="custom-select" name="zone">
                  ...
                  {ZONE.map((zone) =>
                    optionsWithDefaultSelection(zone, program ? program.zone : 'Global')
                  )}
                </select>
              </p>
            </div>
            ...
            <form-group controlId="formContactPhone">
              ...
              {!isValidPhone && (
                <span className="error">
                  Must only contain numbers between 0-9, may start with plus "+" before country
                  code, and may have dash "-"
                </span>
              )}
            </form-group>
            <div>
              ...
              <p className="input-control">
                ...
                <select className="custom-select" name="status">
                  ...
                  {PROGRAM_STATUS.map((status) =>
                    optionsWithDefaultSelection(status, program ? program.status : 'Draft')
                  )}
                </select>
              </p>
            </div>
            ...
            <form-group controlId="formCreationDate">
              <p className="input-control">
                <label id="creationDate">
                  Creation Date : (in {program ? creationDateArray[2] : 'GMT+00:00'} timezone)
                </label>
                <input
                  className="field"
                  ...
                  name="creation_date"
                  defaultValue={
                    program ? `${creationDateArray[0]}T${creationDateArray[1]}` : 'YYYY-MM-DDT00:00'
                  }
                  disabled
                />
              </p>
