...
import { GENDER, AGE, ETHNICITY, SEXUAL_ORIENTATION, RELIGION, PHYSICAL_ABILITY, MENTAL_ABILITY, SOCIO_ECONOMIC, HIGHEST_EDUCATION, YEARS_OF_EXPERIENCE } from "../backgrounds";
...
export default function EditProgram() {
    ...
    const handleSubmit = async (e) => {
        ...
        new FormData(e.target).forEach((value, key) => {
            if (key === "organization_name" || key === "representative_name" || key === "creation_date") return;
            if (
                key === "target_skills" ||
            ...
            if (key === "payment_amount") value = parseInt(value);
            console.log(value);
            if (key === "start_date" || key === "end_date" || key === "creation_date") value = value.split("T").join(" ");
            console.log(payload);
            payload[key] = value;
        });
                    ...
                    <form className="program-form mx-auto" onSubmit={handleSubmit}>
                        <form-group controlId="formprogramName">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" aria-labelledby="programName" name="program_name" maxLength="100" defaultValue={program ? program.program_name : ""} required />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formOrganizationName">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" aria-labelledby="organizationName" name="organization_name" defaultValue={organization.organization_name} disabled />
                            </p>
                        </form-group>
                        <form-group controlId="formRespresentativeName">
                            <p className="input-control">
                                <label id="representativeName">Representative name :</label>
                                <input className="field" type="text" aria-labelledby="representativeName" name="representative_name" defaultValue={organization.representative_name} disabled />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_gender">
                                    <option>{program ? program.target_candidate_gender : "Not Applicable"}</option>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_age">
                                    <option>{program ? program.target_candidate_age : "Not Applicable"}</option>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_ethnicity">
                                    <option>{program ? program.target_candidate_ethnicity : "Not Applicable"}</option>
                                    {ETHNICITY.map((target_candidate_ethnicity) =>
                                        optionsWithDefaultSelection(target_candidate_ethnicity, program ? program.target_candidate_ethnicity : "Not Applicable"),
                                    )}
                                </select>
                            </p>
                        </div>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_sexual_orientation">
                                    <option>{program ? program.target_candidate_sexual_orientation : "Not Applicable"}</option>
                                    {SEXUAL_ORIENTATION.map((target_candidate_sexual_orientation) =>
                                        optionsWithDefaultSelection(target_candidate_sexual_orientation, program ? program.target_candidate_sexual_orientation : "Not Applicable"),
                                    )}
                                </select>
                            </p>
                        </div>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_religion">
                                    <option>{program ? program.target_candidate_religion : "Not Applicable"}</option>
                                    {RELIGION.map((target_candidate_religion) =>
                                        optionsWithDefaultSelection(target_candidate_religion, program ? program.target_candidate_religion : "Not Applicable"),
                                    )}
                                </select>
                            </p>
                        </div>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_physical_ability">
                                    <option>{program ? program.target_candidate_physical_ability : "Not Applicable"}</option>
                                    {PHYSICAL_ABILITY.map((target_candidate_physical_ability) =>
                                        optionsWithDefaultSelection(target_candidate_physical_ability, program ? program.target_candidate_physical_ability : "Not Applicable"),
                                    )}
                                </select>
                            </p>
                        </div>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_mental_ability">
                                    <option>{program ? program.target_candidate_mental_ability : "Not Applicable"}</option>
                                    {MENTAL_ABILITY.map((target_candidate_mental_ability) =>
                                        optionsWithDefaultSelection(target_candidate_mental_ability, program ? program.target_candidate_mental_ability : "Not Applicable"),
                                    )}
                                </select>
                            </p>
                        </div>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_socio_economic">
                                    <option>{program ? program.target_candidate_socio_economic : "Not Applicable"}</option>
                                    {SOCIO_ECONOMIC.map((target_candidate_socio_economic) =>
                                        optionsWithDefaultSelection(target_candidate_socio_economic, program ? program.target_candidate_socio_economic : "Not Applicable"),
                                    )}
                                </select>
                            </p>
                        </div>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_highest_education">
                                    <option>{program ? program.target_candidate_highest_education : "Not Applicable"}</option>
                                    {HIGHEST_EDUCATION.map((target_candidate_highest_education) =>
                                        optionsWithDefaultSelection(target_candidate_highest_education, program ? program.target_candidate_highest_education : "Not Applicable"),
                                    )}
                                </select>
                            </p>
                        </div>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_years_of_experience">
                                    <option>{program ? program.target_candidate_years_of_experience : "Not Applicable"}</option>
                                    {YEARS_OF_EXPERIENCE.map((target_candidate_years_of_experience) =>
                                        optionsWithDefaultSelection(target_candidate_years_of_experience, program ? program.target_candidate_years_of_experience : "Not Applicable"),
                                    )}
                                </select>
                            </p>
                        </div>
                        ...
                        <form-group controlId="formOther">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" aria-labelledby="other" name="target_candidate_other" defaultValue={program ? program.target_candidate_other : ""} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                            ...
                            <p className="input-control">
                                ...
                                <div className="input-group mb-3">
                                    <div className="input-group-prepend">
                                        <label id="paymentCurrency" className="input-group-text">
                                            Currency :
                                        </label>
                                        <input
                                    ...
                                    <label id="paymentAmount" className="input-group-text">
                                        Amount :
                                    </label>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="contact_type">
                                    <option>{program ? program.contact_type : "Remote"}</option>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="zone">
                                    <option>{program ? program.zone : "Global"}</option>
                        ...
                        <form-group controlId="formContactName">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" aria-labelledby="contactName" name="contact_name" maxLength="50" defaultValue={program ? program.contact_name : ""} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formprogramAddress">
                            <p className="input-control">
                                ...
                                <textarea className="field" type="text" aria-labelledby="programAddress" name="program_address" maxLength="250" defaultValue={program ? program.program_address : ""} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formContactPhone">
                            ...
                            {!isValidPhone && <span className="error">Must only contain numbers between 0-9, may start with plus "+" before country code, and may have dash "-"</span>}
                        </form-group>
                        <div>
                            <br></br>
                        </div>
                        <form-group controlId="formContactMobile">
                            ...
                            {!isValidMobile && <span className="error">Must only contain numbers between 0-9, may start with plus "+" before country code, and may have dash "-"</span>}
                        </form-group>
                        <div>
                            <br></br>
                        </div>
                        <form-group controlId="formContactEmail">
                            ...
                            {!isValidEmail && <span className="error">Must match standard email format xxx@xxx.xxx</span>}
                        </form-group>
                        <div>
                            <br></br>
                        </div>
                        <form-group controlId="formprogramWebsite">
                            <p className="input-control">
                                ...
                                <input className="field" type="url" name="program_website" maxLength="254" defaultValue={program ? program.program_website : ""} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formIrcChannel">
                            <p className="input-control">
                                ...
                                <input className="field" type="url" name="irc_channel" maxLength="254" defaultValue={program ? program.irc_channel : ""} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <form-group controlId="formTags">
                            <p className="input-control">
                                ...
                                <input className="field" type="text" name="tags" maxLength="150" defaultValue={program ? program.tags.join(", ") : ""} />
                            </p>
                        </form-group>
                        <div>
                            <br></br>
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="status">
                                    <option>{program ? program.status : "Draft"}</option>
                        ...
                        <div className="row">
                            <div className="col-sm-6 offset-sm-9">
                                <button className="btn btn-success" variant="success" type="submit" name="submit" value="Save">
                                    Save
                                </button>
                                <div>
                                    <br></br>
